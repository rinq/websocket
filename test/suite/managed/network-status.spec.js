...
var OverpassNetworkStatus = require('../../../managed/network-status')

var navigator, windowEmitter, window, timeoutFn, setTimeout

describe('OverpassNetworkStatus', function () {
  beforeEach(function () {
  ...
  it('should emit an offline event when offline during construction', function (done) {
    var subject = new OverpassNetworkStatus(navigator, window, setTimeout)
